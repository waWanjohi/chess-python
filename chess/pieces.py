...
class ChessPiece:
    """
    This represents a typical piece in chess. For legibility, we'll use an enum to name the pieces
...
class Rook(ChessPiece):
    ...
    def is_valid_move(self, board, starting_position, finishing_position) -> bool:
        if starting_position[0] == finishing_position[0] or starting_position[1] == finishing_position[1]:
...
class Knight(ChessPiece):
    ...
    def is_valid_move(self, board, starting_position, finishing_position) -> bool:
        ...
        '''
        if abs(starting_position[0] - finishing_position[0]) == 2 and \
...
class Bishop(ChessPiece):
    ...
    def is_valid_move(self, board, starting_position, finishing_position) -> bool:
        return bishops_moves(board=board, starting_pos=starting_position, finishing_pos=finishing_position)
...
class Queen(ChessPiece):
    ...
    def is_valid_move(self, board, starting_position, finishing_position) -> bool:
        ...
        if (starting_position[0] == finishing_position[0]) or (starting_position[0] == finishing_position[1]):
            return rooks_moves(board=board, starting_pos=starting_position, finishing_position=finishing_position)
        
        # Diagonally like a bishop
        if abs(starting_position[0] - finishing_position[0]) == abs(starting_position[1] - finishing_position[1]):
            return bishops_moves(board=board, starting_pos=starting_position, finishing_pos=finishing_position)
    ...
    def is_valid_move(self, board, starting_position, finishing_position) -> bool:
        ...
        if self.color:
            ...
            if starting_position[0] == (finishing_position[0] + 1) and \
             ((starting_position[1] == finishing_position[1] + 1) or \
            ...
            if starting_position[1] == finishing_position[1]:
                if (starting_position[0] - finishing_position[0] == 2 and self.first_move) or \
